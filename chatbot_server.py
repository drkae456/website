...
def main():
    ...
    # Override system arguments to run the chatbot service on port 8001
    # Original sys.argv will be something like ['chatbot_server.py']
    # We transform it to ['chatbot_server.py', 'runserver', '0.0.0.0:8001']
    chatbot_port = os.environ.get('CHATBOT_PORT', '8001')
